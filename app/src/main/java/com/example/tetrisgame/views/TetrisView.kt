...
import com.example.tetrisgame.GameActivity
import com.example.tetrisgame.constans.CellConstants
import com.example.tetrisgame.constans.FieldConstants
import com.example.tetrisgame.models.Block
...
class TetrisView:View {
    ...
    fun initializeModel(model: AppModel){
        this.model= model
    }
    fun initializeActivity(gameActivity: GameActivity){
    ...
    override fun onSizeChanged(width: Int,height: Int, previousWidth: Int, previousHeight: Int) {
        ...
        this.cellSize = com.example.tetrisgame.views.Dimension(n,n)
        val offsetX = (width-FieldConstants.COLUMN_COUNT.value*n)/2
        val offsetY = (height-FieldConstants.ROW_COUNT.value*n)/2
        this.frameOffset = com.example.tetrisgame.views.Dimension(offsetX,offsetY)
    }
